...
class ConfigurationEntryApi
{
    ...
    protected function deleteConfigurationEntryItemRequest($id)
    {
        ...
        $resourcePath = '/rating/configuration_entries/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \VentureLeap\RatingService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\RatingService\Model\InlineResponse200
     */
     ...
     * @throws \VentureLeap\RatingService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\RatingService\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationEntryCollectionWithHttpInfo($key = null, $sub_key = null, $value = null, $application_id = null, $page = '1')
    {
        $returnType = '\VentureLeap\RatingService\Model\InlineResponse200';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\RatingService\Model\InlineResponse200',
    ...
    protected function getConfigurationEntryCollectionRequest($key = null, $sub_key = null, $value = null, $application_id = null, $page = '1')
    {
        ...
        $resourcePath = '/rating/configuration_entries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \VentureLeap\RatingService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\RatingService\Model\ConfigurationEntryJsonldConfigurationRead
     */
     ...
     * @throws \VentureLeap\RatingService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\RatingService\Model\ConfigurationEntryJsonldConfigurationRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationEntryItemWithHttpInfo($id)
    {
        $returnType = '\VentureLeap\RatingService\Model\ConfigurationEntryJsonldConfigurationRead';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\RatingService\Model\ConfigurationEntryJsonldConfigurationRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
